...
source reduci_vars #input parameters file
...
python hapXphenoPredictor_SW100.V2.py $data $fldr
echo 4. DONE: hapXphenoPredictorSNPs.py - checked haps!
wait

echo $fldr $figs_out
python hapBuilder_SW100.V2.py $fldr $figs_out
wait

echo DONE:HapAnnot.bash:$(date +%F_%T) >> fin.txt
